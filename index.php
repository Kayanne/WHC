    ...
    <div class="row">
        <div class="col-sm">
            <nav class="nav flex-column">
                <a class="nav-link btn-linkedin" href="https://www.linkedin.com/in/samuel-rio-a3b3b5102/"  target="_blank">Linkedin : Samuel Rio</a>
                ...
                <a class="nav-link btn-github" target="_blank" href="vendor/img/cv.pdf">CV</a>
            </nav>
        </div>
        <div class="col-sm">
            <form id="commandForm" class="blocktext center-div center">
                <div class="form-group">
                    ...
                    <input type="text" name="command" class="form-control" placeholder="Command arg1 arg2 arg3 argN"><br>
                </div>
        ...
        <div class="col-sm">
            <div class="p-4 mb-3 bg-light rounded guideline font-italic">
                ...
                <p>repo-desc: perform a GitHub API call using owner and repo arguments to return a description of the repository. ex: repo-desc user repositoryName</p>
            </div>
        </div>
    </div>
    <div class="row">
